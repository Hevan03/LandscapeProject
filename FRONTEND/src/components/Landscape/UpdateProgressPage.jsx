  ...
  return (
    <div className="bg-gray-100 min-h-screen pt-24 pb-12 px-4">
      ...
      >
        ...
        <div className="p-6 border-b border-gray-200">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
            <div className="flex items-center">
              ...
              <span>{staticDetails.landscapeName}</span>
            </div>
            <div className="flex items-center">
              <User size={16} className="mr-2 text-green-600" />
              <span>{staticDetails.customerName}</span>
            </div>
            <div className="flex items-center">
              <HardHat size={16} className="mr-2 text-green-600" />
              <span>{staticDetails.landscaperName}</span>
            </div>
          </div>
        </div>
                  ...
                  <tr key={index}>
                    ...
                    <td className="py-2 px-4 border-b text-center">
                      ...
                      <button
                        ...
                        className="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 flex items-center mx-auto"
                      >
        ...
        <div className="p-6 border-t">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">
            Manage Tasks <span className="text-red-500">*</span>
          </h3>
          <div className="overflow-x-auto">
