...
const ActionCard = ({ title, value, to, imageUrl, icon }) => {
    ...
    return (
        <div 
            onClick={() => navigate(to)}
            className="relative h-48 rounded-2xl shadow-xl cursor-pointer overflow-hidden group"
        >
            {/* Background Image */}
            <div 
            ...
            <div className="relative h-full flex flex-col justify-between p-6 text-white">
                ...
                <div className="text-right">
                    <span className={`text-5xl font-bold tracking-tighter ${title === "Start a New Project" && 'text-4xl'}`}>
                        {value}
                    </span>
                </div>
            </div>
...
const LandscaperHomePage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const [landscaperRes, projectsRes, appointmentsRes] = await Promise.all([
                    axios.get(`http://localhost:5001/api/landscaper/${loggedInLandscaperId}`),
                    axios.get(`http://localhost:5001/api/landscape/landscaper/${loggedInLandscaperId}`),
                    axios.get(`http://localhost:5001/api/appointments/landscaper/${loggedInLandscaperId}`)
                ]);
            ...
            <div className="bg-gray-50">
                <div className="container mx-auto px-6 py-20 text-center">
                    ...
                    <p className="text-gray-600 max-w-3xl mx-auto mb-12">
                        Our platform provides everything you need to manage your landscaping business efficiently, connecting you with clients and simplifying your workflow.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-gray-600">
                                Manage all your projects, from initial design to final touches, in one organized place.
                            </p>
                        </div>
                        {/* clients */}
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-gray-600">
                                Easily handle appointments and communicate with clients to bring their vision to life.
                            </p>
                        </div>
                        {/* Bussiness */}
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-gray-600">
                                Showcase your portfolio, gain visibility, and focus on what you do best: creating beautiful landscapes.
                            </p>
                        </div>
                    </div>
                </div>
