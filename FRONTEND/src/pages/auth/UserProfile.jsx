  ...
  if (!user) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white p-8 rounded-xl shadow-lg text-center">
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="bg-white rounded-2xl shadow-xl overflow-hidden">
          {/* Header Section */}
          ...
          <div className="p-8">
            ...
            <div className="mb-8 p-6 bg-gradient-to-br from-green-50 to-blue-50 rounded-xl">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="px-4 py-1 bg-green-100 text-green-700 rounded-full text-sm font-medium">{user.loyaltyLevel || "Bronze"}</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div className="bg-gradient-to-r from-green-500 to-teal-600 h-2.5 rounded-full" style={{ width: `${progress}%` }}></div>
              </div>
            ...
            <div className="mt-8 p-6 bg-gradient-to-br from-green-50 to-blue-50 rounded-xl">
              ...
              <div className="flex items-center gap-4">
                <div className="flex-1 bg-white p-3 rounded-lg border border-gray-200">
                  <code className="text-green-600 font-mono">{user.registrationNumber || "Not available"}</code>
                </div>
                <button onClick={handleCopyReferral} className="p-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">
                  <ClipboardIcon className="w-5 h-5" />
                </button>
              </div>
              <p className="mt-2 text-sm text-gray-600">Share this code with friends and earn 100 points for each referral!</p>
            </div>
          </div>
        </motion.div>
      </div>
