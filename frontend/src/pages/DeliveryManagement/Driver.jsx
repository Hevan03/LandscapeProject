...
import { BsPersonBadge, BsPlusCircle, BsPencilSquare, BsTrash, BsClockHistory, BsInfoCircle } from 'react-icons/bs';
...
const Driver = () => {
    ...
    const [newDriver, setNewDriver] = useState({ name: '', contact: '', licenseNo: '', availability: 'Available' });
    ...
    try {
        ...
        setNewDriver({ name: '', contact: '', licenseNo: '', availability: 'Available' });
        ...
        <div className="min-h-screen">
            ...
            <div className="bg-gray-100 min-h-screen p-8 font-sans">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-lg">
                    <h2 className="text-xl font-semibold text-gray-700 mb-4">Driver List</h2>
                                ...
                                {drivers.length > 0 ? (
                                    drivers.map(driver => (
                                        <tr key={driver._id} className="hover">
                                            ...
                                            <td>
                                                <div className={`badge ${getAvailabilityBadge(driver.availability)} text-white`}>
                                                    {driver.availability}
                                                </div>
                                            </td>
                                    ...
                                    <tr>
                                        <td colSpan="6" className="text-center text-gray-500 py-8">No drivers found.</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
...
/>
                            ...
                            <div className="modal-action">
                                <button type="submit" className="btn bg-green-700 hover:bg-green-800 text-white">{editingDriverId ? "Update" : "Add"}</button>
                ...
                <dialog open={isHistoryModalOpen} className="modal">
                    <div className="modal-box bg-white p-6 rounded-xl shadow-xl">
                        ...
                        <div className="overflow-x-auto">
                            <p className="text-gray-500 italic">This feature is not yet connected to the backend. The data below is for demonstration only.</p>
                            <table className="table w-full">
                                <thead>
                                    <tr>
                                        <th>Order ID</th>
                                ...
                                <tbody>
                                    ...
                                    {selectedDriver && selectedDriver.deliveries && selectedDriver.deliveries.map((delivery, index) => (
                                        <tr key={index}>
                                            <td>{delivery.id}</td>
                        ...
                        <div className="modal-action">
                            <button className="btn btn-ghost" onClick={() => setIsHistoryModalOpen(false)}>Close</button>
                        </div>
                    </div>
                </dialog>
            </div>
