...
import { BsTruck, BsPlusCircle, BsPencilSquare, BsTrash, BsInfoCircle } from 'react-icons/bs';
...
const Vehicles = () => {
    ...
    const [newVehicle, setNewVehicle] = useState({ vehicleNo: '', type: '', status: 'Available' });
    ...
    const handleAddOrEditSubmit = async (e) => {
        ...
        try {
            ...
            toast.error("Failed to save vehicle. Check for duplicate vehicle number.");
        }
    };
        ...
        <div className="min-h-screen">
            ...
            <div className="bg-gray-100 min-h-screen p-8 font-sans">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-lg">
                    <h2 className="text-xl font-semibold text-gray-700 mb-4">Vehicle List</h2>
                                ...
                                {vehicles.length > 0 ? (
                                    vehicles.map(vehicle => (
                                        <tr key={vehicle._id} className="hover">
                                            ...
                                            <td>{vehicle.type}</td>
                                            <td>
                                                <div className={`badge badge-lg ${getStatusBadge(vehicle.status)} text-white`}>
                                                    {vehicle.status}
                                                </div>
                                            </td>
                                    ...
                                    <tr>
                                        <td colSpan="4" className="text-center text-gray-500 py-8">No vehicles found.</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
                ...
                <dialog open={isModalOpen} className="modal">
                    <div className="modal-box bg-white p-6 rounded-xl shadow-xl">
                        <h3 className="font-bold text-lg mb-4">{editingVehicleId ? "Edit Vehicle" : "Add New Vehicle"}</h3>
                        <form onSubmit={handleAddOrEditSubmit}>
                            ...
                            <div className="modal-action">
                                <button type="submit" className="btn bg-green-700 hover:bg-green-800 text-white">
