    ...
    useEffect(() => {
        const fetchDashData = async () => {
            try {
                ...
                const dashboardNotifications = allNotifications.filter(n => 
                  n.type === 'payment_received' || n.type === 'accident_reported'
                );
        ...
        <div className="min-h-screen">
            ...
            <div className="mb-8">
                <h2 className="text-xl font-semibold text-gray-700 mb-4 flex items-center">
                    ...
                    {unreadNotifications > 0 && (
                        <span className="badge badge-error badge-sm ml-2">{unreadNotifications}</span>
                    )}
                </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-8">
                ...
                <Link to="/DeliveryManagement/delivery-assign" className="card bg-white shadow-xl rounded-xl transition-transform transform hover:scale-105 hover:shadow-2xl">
                    <div className="card-body flex items-center justify-center p-6">
                ...
                <Link to="/DeliveryManagement/delivery-reports" className="card bg-white shadow-xl rounded-xl transition-transform transform hover:scale-105 hover:shadow-2xl">
                    <div className="card-body flex items-center justify-center p-6">
                ...
                <Link to="/DeliveryManagement/driver" className="card bg-white shadow-xl rounded-xl transition-transform transform hover:scale-105 hover:shadow-2xl">
                    <div className="card-body flex items-center justify-center p-6">
                ...
                <Link to="/DeliveryManagement/vehicles" className="card bg-white shadow-xl rounded-xl transition-transform transform hover:scale-105 hover:shadow-2xl">
                    <div className="card-body flex items-center justify-center p-6">
                ...
                <Link to="/AdminPaymentDashboard" className="card bg-white shadow-xl rounded-xl transition-transform transform hover:scale-105 hover:shadow-2xl">
                    <div className="card-body flex items-center justify-center p-6">
                        <FaCreditCard size={48} className="text-green-700 mb-2" />
                        <p className="text-center font-semibold text-gray-700">Payments Manage</p>
                    </div>
                </Link>
                <Link to="/DeliveryManagement/accident-reports" className="card bg-white shadow-xl rounded-xl transition-transform transform hover:scale-105 hover:shadow-2xl">
                    <div className="card-body flex items-center justify-center p-6">
                        <BsFileText size={48} className="text-green-700 mb-2" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="card bg-white shadow-lg rounded-xl">
                    <div className="card-body p-6">
                        ...
                        <div className="card-actions justify-end mt-4">
                            <a href="/AdminPaymentDashboard" className="btn btn-sm text-white font-bold py-2 px-4 rounded-full shadow-lg transition-colors duration-300 bg-gradient-to-r from-green-600 to-green-800 hover:from-green-700 hover:to-green-900">View History</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="card bg-white shadow-lg rounded-xl">
                    <div className="card-body p-6">
                        ...
                        <div className="card-actions justify-end mt-4">
                            <a href="/DeliveryManagement/delivery-assign" className="btn btn-sm text-white font-bold py-2 px-4 rounded-full shadow-lg transition-colors duration-300 bg-gradient-to-r from-green-600 to-green-800 hover:from-green-700 hover:to-green-900">Assign Deliveries</a>
                        </div>
                    </div>
                </div>
            </div>
