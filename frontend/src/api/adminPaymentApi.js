...
const API_INVENTORY = axios.create({ baseURL: 'http://localhost:5000/item-payments' });
const API_SERVICE = axios.create({ baseURL: 'http://localhost:5000/main-payments' }); // Assuming this is your service payments route
