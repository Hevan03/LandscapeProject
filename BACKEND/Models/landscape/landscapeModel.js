...
const landscapeSchema = new mongoose.Schema(
  {
    ...
    landscaperId: { type: mongoose.Schema.Types.ObjectId, ref: "Landscaper", required: true },
    status: { type: String, enum: ["Advance Payment Pending", "In Progress", "Completed"], default: "Advance Payment Pending" },

    accountStatus: { type: String, enum: ["pending", "approved"], default: "pending" },
