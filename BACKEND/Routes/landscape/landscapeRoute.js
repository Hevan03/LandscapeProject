...
import {
  ...
  updateLandscape,
  deleteLandscape,
  getLandscapesForLandscaper,
  requestBlueprint,
  uploadBlueprint,
  getLandscapesForCustomer,
  createAdvancePaymentOrder,
  createBalancePaymentOrder,
  updateProjectStatus,
} from "../../Controllers/landscape/landscapeController.js";
...
router.post("/advance", createAdvancePaymentOrder);
router.post("/balance", createBalancePaymentOrder);
