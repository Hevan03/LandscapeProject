...
export async function updateitem(req, res) {
    try {
        const { itemname, category, subcategory, price, quantity, description, imageUrl } = req.body;

        let updateData = { itemname, category, subcategory, price, quantity, description };
